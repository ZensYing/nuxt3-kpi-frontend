  ...
  <div class="container mx-auto px-6 py-10 max-w-5xl">
    ...
    <div class="mb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div v-for="platform in platforms" :key="platform.id" @click="selectPlatform(platform.id)"
          ...
          <div class="p-6">
            <div class="flex items-center mb-3">
              <div class="w-10 h-10 rounded-full flex items-center justify-center mr-3"
                :style="`background-color: ${platform.project_color}`">
                <span class="text-white font-bold text-lg">{{ platform.project_name.charAt(0) }}</span>
              </div>
              <h3 class="text-lg font-semibold" :style="`color: ${platform.project_color}`">{{ platform.project_name }}
              </h3>
            </div>
    ...
    <div v-if="platformSettings" class="bg-white shadow-xl rounded-xl p-8 transition-all duration-300">
      ...
      <div class="mt-6 p-6 bg-gray-50 rounded-xl border border-gray-200">
        ...
        <NuxtLink :to="`/dashboard/ads/report-${selectedPlatform}`"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="p-4 rounded-lg bg-white shadow-sm border border-gray-100">
            ...
            <a :href="platformSettings.website_url" target="_blank"
          ...
          <div class="p-4 rounded-lg bg-white shadow-sm border border-gray-100">
            ...
            <a :href="platformSettings.directusUrl" target="_blank"
              class="text-blue-600 hover:underline flex items-center gap-1">
