  ...
  <BackgroundAnimationLines class="hidden dark:block" />
    ...
    <div class="css-blurry-gradient-green"></div>
      ...
      <div class="absolute inset-0 flex items-center justify-center">
        <div
          class="w-[500px] h-[500px] bg-purple-500/30 rounded-full filter blur-[100px] opacity-20 animate-pulse-slow"
        ></div>
      </div>
      ...
      <div class="container mx-auto px-6 relative z-10">
        <div class="max-w-6xl mx-auto">
            ...
            >
              <div class="space-y-4">
                <div class="flex items-center justify-between">
                  <h3
                    class="text-lg font-semibold text-white transition-colors duration-300"
                  >
                    {{ skill.name }}
                  </h3>
          ...
          >
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              ...
              >
                ...
                <span
                  class="text-gray-300 text-sm group-hover:text-blue-400 transition-colors duration-300"
                >
                  {{ tech.name }}
                </span>
              </div>
          ...
          <div class="mt-16 text-center">
            <p
              class="text-gray-400 max-w-2xl mx-auto hover:text-gray-300 transition-colors duration-300"
            >
              ...
              and AI integration in web applications.
            </p>
          </div>
        </div>
      </div>
